...
import { SiteContent, TeamMember, Testimonial, StatItem, StoryBlock } from '../types';

// --- DEFAULT DATA (The original hardcoded data) ---
const defaultContent: SiteContent = {
  hero: {
    tagline: "Established 2020",
    titleLine1: "More than music,",
    titleLine2: "a movement.",
    subtitle: "Student-led music education nurturing confidence, creativity, and collaboration in the next generation."
  },
  stats: [
  ...
  mission: {
    title: "Mission",
    text: "To inspire and empower musicians of all ages by providing accessible, student-led music education that nurtures confidence, creativity, and collaboration.",
    subText: "Through performance, mentorship, and community, we transform passion into lifelong skills both on and off the stage."
  },
  vision: {
    title: "Vision",
  ...
  testimonials: [
    { id: 't1', quote: "Cadence Collective helped me build confidence in my vocals... I definitely feel my skills have improved.", author: "Eliza", role: "Year 7" },
    { id: 't2', quote: "Working on our solos was my favourite moment because it made me feel like my voice had space to grow.", author: "Nabiha", role: "Year 7" },
    { id: 't3', quote: "It was fun, interactive, and genuinely enjoyable. Even though I couldn't turn on my camera... I still felt included.", author: "Serah", role: "Year 10" },
    { id: 't4', quote: "The perfect place for me to overcome my stage fear.", author: "Nandana", role: "Year 10" },
  ],
  team: [
    {
      id: 'tm1',
      ...
      featuredIn: [
        "Khaleej Times UAE", "Talk 100.3", "Dubai Eye 103.8", "PHLV Radio: Music Asia, Los Angeles", "DubaiOne TV", "Teachers Talk Radio", "Expat Media UAE"
      ]
    },
    {
      id: 'tm2',
      ...
      shortBio: "Shapes visual identity and storytelling. Music is her source of emotional clarity. Ensures the Collective's work is authentic and impactful.",
      image: "https://picsum.photos/401/500?grayscale",
      fullBio: "Isabella Yarshenko serves as the Chief Content Officer of Cadence Collective, shaping the visual identity, tone, and storytelling across all platforms. She brings a sharp eye for detail, a clear creative voice, and a commitment to presenting the Collective’s work with authenticity and impact.",
      ...
      roleFocus: "Isabella curates, edits, and posts content with relevant captions and hashtags, ensuring everything reflects the Collective’s personality while staying engaging, consistent, and creatively aligned."
    },
    {
      id: 'tm3',
      name: "Krrish",
      role: "Chief Marketing Officer",
      shortBio: "Leads marketing direction. Passionate about merging music and art into a unified creative ecosystem to connect people.",
      image: "https://picsum.photos/402/500?grayscale",
      fullBio: "Krrish leads the marketing direction of Cadence Collective as Chief Marketing Officer. He focuses on shaping brand identity, developing strategy, and expanding the Collective’s reach with campaigns that are bold, thoughtful, and artist-focused.",
      personalConnection: "Krrish is passionate about merging music and art into a unified creative ecosystem. He values the way music sparks collaboration, fuels expression, and connects people from completely different backgrounds. That belief sits at the core of his work.",
      roleFocus: "He drives social media strategy, audience growth, and community engagement — building pathways for the Collective to reach more artists, inspire new audiences, and strengthen its presence across platforms."
    }
  ]
};
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const resetToDefaults = () => {
    if (window.confirm("Are you sure? This will erase all your edits and restore the original website data.")) {
      setContent(defaultContent);
      localStorage.setItem('cadence_content', JSON.stringify(defaultContent));
    }
  };

  if (!isLoaded) return null; // Or a small loader
